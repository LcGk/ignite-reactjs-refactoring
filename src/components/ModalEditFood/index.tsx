  ...
  return (
    <Modal isOpen={isOpen} setIsOpen={setIsOpen}>
      <Form ref={formRef} onSubmit={handleSubmit} initialData={editingFood}>
        ...
        <button type="submit" data-testid="update-food-button">
          <p className="text">Atualizar Prato</p>
          <div className="icon">
